...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            'nameRequired' => ['name', 'required', 'on' => ['register']],
            'nameLength'   => ['name', 'string'],
            'mobileRequired' => ['mobile', 'required', 'on' => ['register']],
            'mobileLength'   => ['mobile', 'string'],
            'pincodeRequired' => ['pincode', 'required', 'on' => ['register']],
